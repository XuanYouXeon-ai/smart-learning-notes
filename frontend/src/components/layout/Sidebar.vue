...
const menuItems = [
  ...
  { path: '/notes', name: '笔记库', icon: 'folder' },
  { path: '/notes/upload', name: '上传笔记', icon: 'upload' },
  { path: '/review', name: '智能复习', icon: 'review' },
  { path: '/history', name: '学习记录', icon: 'history' },
  { path: '/qa', name: '智能问答', icon: 'chat' }
]
...
<template>
  ...
  >
    <div class="p-4 border-b border-slate-700 flex items-center justify-between">
      <span v-if="!isCollapsed" class="text-lg font-bold">智能学习笔记</span>
      <button @click="toggleSidebar" class="p-1 hover:bg-slate-700 rounded">
        <svg
